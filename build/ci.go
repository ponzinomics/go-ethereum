...
import (
	...
	"github.com/ponzinomics/go-ethereum/crypto/signify"
	"github.com/ponzinomics/go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/ponzinomics/go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/ponzinomics/go-ethereum/internal/version.gitDate="+env.Date)
	}
